...
function c78310590.initial_effect(c)
	...
	e3:SetCountLimit(1,78310590+100)
	...
	e5:SetCountLimit(1,78310590+200)
...
function c78310590.cfilter(c,tp)
	return bit.band(c:GetPreviousTypeOnField(),TYPE_PENDULUM)~=0 and c:IsPreviousLocation(LOCATION_MZONE) and c:GetPreviousControler()==tp
end
